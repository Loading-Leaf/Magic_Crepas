...
class _TutorialPageState extends State<TutorialPage> {
  ...
  List<String> chapters = [
    ...
    "モードを選ぶことができるよ！\n次のページからモードの説明するよ",
    "それぞれのモードの話をするよ！\nAは絵の世界に入ることができ、Bはリアルに絵の世界の物を召喚できるよ！",
    "「ワイドモードA」はテーブルや人など複数ある時にオススメ！",
    "「オブジェクトモードA」はおやつとか近くにある時にオススメ！\n逆に複数人がいる写真には向いてないんだ！",
    "「ワイドモードB」はテーブルや人など複数ある時にオススメ！",
    "「オブジェクトモードB」はおやつとか近くにある時にオススメ！\n特にこのモードは召喚しやすいよ！",
    "「アートをつくる」で「オブジェクトモードA」のアートを作ろう！\n※ネットつながるところで行ってね",
    "作ってる間はまちがいさがしであそぼう",
