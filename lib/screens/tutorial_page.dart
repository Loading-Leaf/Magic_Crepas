...
class _TutorialPageState extends State<TutorialPage> {
  ...
  List<String> chapters = [
    ...
    "モードを選ぶことができるよ！\n次のページからモードの説明するよ",
    "それぞれのモードの話をするよ！\nAは絵の世界に入ることができ、Bはリアルに絵の世界の物を呼び出すことができるよ！",
    "「モードA」はテーブルや人など複数ある時にオススメ！",
    "「モードB」はおやつとか近くにある時にオススメ！\n逆に複数人がいる写真には向いてないんだ！",
    "「モードC」はテーブルや人など複数ある時にオススメ！",
    "「モードD」はおやつとか近くにある時にオススメ！\n特にこのモードは呼び出すことができるよ！",
    "「アートをつくる」で「モードA」のアートを作ろう！\n※ネットつながるところで行ってね",
    "AIが絵を作ってる間はまちがいさがしであそぼう",
