  ...
  Widget build(BuildContext context) {
    ...
    List<String> chapters5 = [
      ...
      languageProvider.isHiragana
          ? "モードCでかいたえだよ\nつくったえをタップしてみよう"
          : "モードCで描いた絵だよ\n作った絵をタップしてみよう",
      languageProvider.isHiragana ? "クレヨンのようにアートができているね" : "クレヨンのようにアートができているね",
      languageProvider.isHiragana
    ...
    List<String> chapters8 = [
      ...
      languageProvider.isHiragana
          ? "そうするとうしろはひらがなになったよ\n※りようきやくとおといあわせはいじょう"
          : "そうすると後ろはひらがなになったよ\n※利用規約とお問い合わせは除く",
      languageProvider.isHiragana ? "すべてひらがなになったホームがめんだよ" : "全てひらがなになったホーム画面だよ",
      languageProvider.isHiragana
    ...
    final List<List<String>> chaptersLists = [
      chapters1,
      chapters2,
      chapters3,
      chapters4,
    ...
    List<Widget> buildTutorialGrid() {
      ...
      for (int rowIndex = 0; rowIndex < 2; rowIndex++) {
        ...
        for (int colIndex = 0; colIndex < 2; colIndex++) {
          int itemIndex = startIndex + (rowIndex * 2) + colIndex;
